...
import (
	...
	"github.com/eduardodataa/graphql/graph/generated"
	"github.com/eduardodataa/graphql/graph/model"
)
...
func (r *mutationResolver) CreatChapter(ctx context.Context, input model.NewChapter) (*model.Chapter, error) {
